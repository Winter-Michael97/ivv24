...
export default function Q1() {
    ...
    const articleTexts: { [key: string]: string } = {
        article1: "Im vergangenen Jahr tötete ein 39-Jähriger eine vierköpfige Familie bei einem Brandanschlag in Solingen. Laut Ermittler*innen sei die Tat unpolitisch. Doch der Täter besaß rechtsextremes NS-Propaganda-Material und zündelte am selben Haus bereits am 9. November 2022. Wie unpolitisch kann diese Tat sein?",
        ...
        // false
        article3: "Viele Menschen erinnerte diese Tat an den Brandanschlag von 1993, bei dem vier Rechtsextreme fünf Mitglieder der Familie Genç ermordeten. Dennoch schlossen die zuständigen Wuppertaler Behörden rasch ein rechtsextremes Motiv aus, es gäbe keine Hinweise darauf, hieß es.",
        // true, Unklarer-Zuschreibungs-Bias: 0.8
        ...
        article4: "Im Januar 2025 begann dann der Prozess gegen den Tatverdächtigen vor dem Wuppertaler Landgericht. Im Februar gestand er über seinen Anwalt, für den Brandanschlag verantwortlich zu sein. Er habe vor der Tat Drogen konsumiert. 14 Tage nach dem Brandanschlag griff der Angeklagte einen Mann mit einer Machete an. Ein Zeuge berichtete hier von einem „Sieg Heil“-Ruf des Täters. Ein politisches Motiv spielte im Brand-Prozess lange keine Rolle – bis zu diesem Montag, dem 10. März.",
        // false
        article5: "166 Bilder, die auf dem Rechner des Angeklagten gefunden und an jenem Tag im Prozess präsentiert wurden, zeichnen nun ein Bild, das an einem unpolitischen Motiv zweifeln lässt. Die Bilder zeigen Nazi-Propaganda und grausame, entmenschlichende Witzbilder",
        ...
        article11: "Die Staatsanwaltschaft legt dem Angeklagten zwei weitere Brandstiftungen zur Last: Am 16. Februar 2024 in einem anderen Mehrfamilienhaus im Solinger Stadtgebiet und am 9. November 2022 im selben Mehrfamilienhaus, in dem 2024 vier Menschen starben. Der 9. November ist der Gedenktag an die Novemberpogrome.",
        // false
        article12: ".An jenem Tag 1938 plünderten, zerstörten und verbrannten Nazis jüdische Geschäfte und das Eigentum jüdischer Menschen. Es war der Start der Eskalation der antisemitischen Agenda der Nationalsozialisten. Das Ziel war die Vernichtung der europäischen Jüdinnen und Juden. Alleine dieses geschichtsträchtige Datum hätte doch Ermittler*innen aufhorchen lassen müssen. Hellhörig wurden jedoch nur Aktivist*innen und Betroffene aus der Zivilgesellschaft. Zugehört hat man ihnen jedoch nicht.",
        // false
        article13: "Der NSU-Komplex, Mannheim, Magdeburg und nun auch wieder Solingen: Paradebeispiele dafür, wie rechtsextreme Gewalt, ja sogar Mord, in Deutschland strukturell und institutionell bagatellisiert, sogar ignoriert wird."

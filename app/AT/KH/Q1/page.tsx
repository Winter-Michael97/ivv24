...
export default function Q1() {
    ...
    const articleTexts: { [key: string]: string } = {
        ...
        article7: "Außerdem machte sie großzügige Ankündigungen: Man werde im Falle eines Wahlsiegs unter anderem die Unternehmenssteuer, die Einkommens-, die Konsum-, Strom- und Energiekosten senken.",
        // false
        article8: " Die Berechnungen des Deutschen Instituts für Wirtschaftsforschung (DIW), dass dadurch Haushaltslöcher in Höhe von 181 Milliarden Euro entstehen würden, nannte Weidel im Interview mit den tagesthemen \"hochgradig unseriös\". Eine aus ihrer Sicht seriöse Summe nannte sie nicht.",
        ...
        article10: "Auch Herbert Kickl, der wahrscheinliche nächste Bundeskanzler Österreichs, meldete sich per Video zu Wort. \"Wir fiebern in diesem Wahlkampf mit euch mit\", sagte der Politiker der rechtspopulistischen FPÖ und nannte seine Partei und die AfD Partner. Die AfD sei die einzige Partei, die auf das Volk höre. Weidel bezeichnete er als Kämpfernatur. \"Du bist in jeder Hinsicht allen Deinen Gegenspielern haushoch überlegen\", so Kickl"

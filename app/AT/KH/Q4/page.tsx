...
export default function Q1() {
    ...
    const articleTexts: { [key: string]: string } = {
        article1: "Der Weg zur Neuwahl bei einem Auseinanderbrechen der Ampel ist im Grundgesetz genau festgeschrieben. Theoretisch könnten zwar die verbliebenen Teile der Koalition bis zum regulären Wahltermin am 28. September kommenden Jahres eine Minderheitsregierung bilden.",
        // false
        article2: "Wahrscheinlich ist dies jedoch nicht. Ein solches Bündnis müsste sich für jedes Gesetzesvorhaben mit Stimmen aus der Opposition eine Mehrheit suchen. Das dürfte schon bei der wichtigen Frage des Bundeshaushalts 2025 nicht gelingen.",
        ...
        article3: "Nach Artikel 67 Grundgesetz kann der Bundestag dem Kanzler das Misstrauen aussprechen – allerdings nur, indem er mit Mehrheit einen Nachfolger oder eine Nachfolgerin wählt. Er würde dann den Bundespräsidenten ersuchen, den bisherigen Kanzler zu entlassen. Dazu wäre der Bundespräsident verpflichtet. Er müsste den neu Gewählten ernennen.",
        // false
        article4: "Hierfür gibt es in der Bundesrepublik bislang nur ein Beispiel: 1982 wechselte die FDP vom bisherigen Koalitionspartner SPD und ihrem Kanzler Helmut Schmidt zur CDU/CSU und wählte zusammen mit der Union Helmut Kohl (CDU) zum neuen Kanzler. Der Unterschied zu heute: Damals hatten CDU/CSU und FDP zusammen eine Mehrheit im Bundestag, heute hätten sie diese nicht.",
        // false
        article5: "Diese Möglichkeit nach Artikel 68 Grundgesetz wäre die wahrscheinliche Variante. Der Bundeskanzler würde im Bundestag beantragen, ihm das Vertrauen auszusprechen – in der Erwartung, dass das Parlament dies gerade nicht tut, er also keine Mehrheit bekommt. Der Kanzler kann dies – muss es allerdings nicht – mit einem konkreten Gesetzgebungsvorhaben verknüpfen, also aktuell etwa mit dem Tariftreuegesetz, das die FDP ablehnt. Erhält der Kanzler keine Mehrheit, kann er den Bundespräsidenten bitten, den Bundestag aufzulösen.",
        ...
        article6: "Zuletzt verfuhr Gerhard Schröder (SPD) im Jahr 2005 so. Dieses Vorgehen ist jedoch umstritten, weil es nicht – wie im Grundgesetz intendiert – darauf abzielt, das Vertrauen ausgesprochen zu bekommen, sondern gerade im Gegenteil, die dafür nötige Mehrheit zu verfehlen.",
        ...
        article10: "Zerbräche die Ampel an der FDP, dann würde der Kanzler den Bundespräsidenten bitten, deren Minister (Finanzen, Justiz, Verkehr, Bildung) zu entlassen. Ihre Aufgaben könnten von anderen Ressortchefs mit übernommen werden. Der Kanzler könnte aber auch Nachfolger vorschlagen und vom Bundespräsidenten ernennen lassen.",
        // false
        article11: "Würde der Bundestag aufgelöst und eine Neuwahl angesetzt, käme das politische Handeln aber trotzdem mit einem Schlag zum Erliegen. Die Parteien würden umgehend in den Wahlkampfmodus umschalten, die Vorbereitungszeit für die Wahl wäre extrem kurz. Relevant wäre dies vor allem für den Bundeshaushalt 2025, der dann nicht mehr in diesem Jahr verabschiedet werden könnte.",
        // false
        article12: "Dies wäre allerdings kein Problem. Es träte dann die sogenannte vorläufige Haushaltsführung ein. Ab Januar dürften im Wesentlichen nur noch Ausgaben getätigt werden, für die eine gesetzliche Verpflichtung vorliegt. Dieses Verfahren ist erprobt.",
        // false
        article13: "Es wird immer nach Bundestagswahlen wirksam, weil der Haushaltsentwurf der alten Regierung verfällt und die neue Regierung regelmäßig erst im neuen Jahr ihren eigenen Etatentwurf vorlegt."
        // false
        // Zusammenfassung:
